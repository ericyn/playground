            ...
            return MaterialPageRoute<void>(
              ...
              builder: (BuildContext context) {
                switch (routeSettings.name) {
                  ...
                  case FaceDetectionView.routeName:
                    return const FaceDetectionView();
                  case DragSelect.routeName:
                    return const DragSelect();
                  case AnimatedGradient.routeName:
                    return const AnimatedGradient();
                  case SubstackView.routeName:
                    return const SubstackView();
